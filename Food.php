 ...
 ?>
            ...
            <form method="get" action="";>
                 <button id="btn" name="btn15" onClick="
                    <?php 
                    if (isset($_GET["btn15"])){
                    $sql14 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 15";
            ...
            <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn16" onClick="
                    <?php 
                    if (isset($_GET["btn16"])){
                    $sql15 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 16";
            ...
            <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn17" onClick="
                    <?php 
                    if (isset($_GET["btn17"])){
                    $sql16 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 17";
            ...
            <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn18" onClick="
                    <?php 
                    if (isset($_GET["btn18"])){
                    $sql17 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 18";
            ...
            <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn19" onClick="
                    <?php 
                    if (isset($_GET["btn19"])){
                    $sql18 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 19";
            ...
            <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn20" onClick="
                    <?php 
                    if (isset($_GET["btn20"])){
                    $sql19 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 20";
            ...
            <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn21" onClick="
                    <?php 
                    if (isset($_GET["btn21"])){
                    $sql20 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 21";
              ...
              <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn22" onClick="
                    <?php 
                    if (isset($_GET["btn22"])){
                    $sql21 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 22";
              ...
              <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn23" onClick="
                    <?php 
                    if (isset($_GET["btn23"])){
                    $sql22 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 23";
              ...
              <h1><?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn24" onClick="
                    <?php 
                    if (isset($_GET["btn24"])){
                    $sql23 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 24";
