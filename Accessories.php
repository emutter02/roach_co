 ...
 ?>
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn26" onClick="
                    <?php 
                    if (isset($_GET["btn26"])){
                    $sql25 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 26";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn27" onClick="
                    <?php 
                    if (isset($_GET["btn27"])){
                    $sql26 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 28";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn28" onClick="
                    <?php 
                    if (isset($_GET["btn28"])){
                    $sql27 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 29";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn29" onClick="
                    <?php 
                    if (isset($_GET["btn29"])){
                    $sql28 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 30";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn31" onClick="
                    <?php 
                    if (isset($_GET["btn31"])){
                    $sql30 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 31";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn32" onClick="
                    <?php 
                    if (isset($_GET["btn32"])){
                    $sql31 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 32";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn33" onClick="
                    <?php 
                    if (isset($_GET["btn33"])){
                    $sql32 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 38";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn39" onClick="
                    <?php 
                    if (isset($_GET["btn39"])){
                    $sql38 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 39";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn40" onClick="
                    <?php 
                    if (isset($_GET["btn40"])){
                    $sql39 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 40";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn41" onClick="
                    <?php 
                    if (isset($_GET["btn41"])){
                    $sql40 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 41";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn42" onClick="
                    <?php 
                    if (isset($_GET["btn42"])){
                    $sql41 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 42";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn43" onClick="
                    <?php 
                    if (isset($_GET["btn43"])){
                    $sql42 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 43";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn44" onClick="
                    <?php 
                    if (isset($_GET["btn44"])){
                    $sql43 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 44";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn45" onClick="
                    <?php 
                    if (isset($_GET["btn45"])){
                    $sql44 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 45";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn46" onClick="
                    <?php 
                    if (isset($_GET["btn46"])){
                    $sql45 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 46";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn47" onClick="
                    <?php 
                    if (isset($_GET["btn47"])){
                    $sql46 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 47";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn58" onClick="
                    <?php 
                    if (isset($_GET["btn58"])){
                    $sql57 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 58";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn59" onClick="
                    <?php 
                    if (isset($_GET["btn59"])){
                    $sql58 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 59";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn64" onClick="
                    <?php 
                    if (isset($_GET["btn64"])){
                    $sql63 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 64";
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn65" onClick="
                    <?php 
                    if (isset($_GET["btn65"])){
                    $sql64 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 65";
