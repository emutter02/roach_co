 ...
 ?>
            ...
            <?php
                ...
                <form method="get" action="";>
                 <button id="btn" name="btn" onClick="
                    <?php 
                    if (isset($_GET["btn"])){
                    $sql = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 1";
                    $result = $db->query($sql);
                    }
                ?>"> Add to Cart</button>
                </form>
      ...
      <form method="get" action="";>
                 <button id="btn" name="btn2" onClick="
                    <?php 
                    if (isset($_GET["btn2"])){
                    $sql1 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 2";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn3" onClick="
                    <?php 
                    if (isset($_GET["btn3"])){
                    $sql2 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 3";
        ...
        <h1><?php $sql = "SELECT * FROM products WHERE id = 4";
            ...
            <form method="get" action="";>
                 <button id="btn" name="btn4" onClick="
                    <?php 
                    if (isset($_GET["btn4"])){
                    $sql3 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 4";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn5" onClick="
                    <?php 
                    if (isset($_GET["btn5"])){
                    $sql4 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 5";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn6" onClick="
                    <?php 
                    if (isset($_GET["btn6"])){
                    $sql5 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 6";
       ...
       <form method="get" action="";>
                 <button id="btn" name="btn8" onClick="
                    <?php 
                    if (isset($_GET["btn8"])){
                    $sql7 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 8";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn9" onClick="
                    <?php 
                    if (isset($_GET["btn9"])){
                    $sql8 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 9";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn10" onClick="
                    <?php 
                    if (isset($_GET["btn10"])){
                    $sql9 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 10";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn11" onClick="
                    <?php 
                    if (isset($_GET["btn11"])){
                    $sql10 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 11";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn12" onClick="
                    <?php 
                    if (isset($_GET["btn12"])){
                    $sql11 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 12";
        ...
        <form method="get" action="";>
                 <button id="btn" name="btn13" onClick="
                    <?php 
                    if (isset($_GET["btn13"])){
                    $sql12 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 13";
        ...
        <h1><?php $sql = "SELECT * FROM products WHERE id = 14";
         ...
         <form method="get" action="";>
                 <button id="btn" name="btn14" onClick="
                    <?php 
                    if (isset($_GET["btn14"])){
                    $sql13 = "INSERT INTO cart SELECT id, name, price FROM products WHERE id = 14";
